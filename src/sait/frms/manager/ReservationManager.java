...
/**
 * This is the ReservationManager object that stores the data of everything
...
public class ReservationManager {
	...
	/**
	 * Initializes each parameter inside of ReservationManager without active parameter.
	 * 
	 ...
	 */
	public ReservationManager(String code, String flightCode, String airline, String name, String citizenship,
			double cost) {
		this.code = code;
	...
	/**
	 * Initializes each parameter inside of ReservationManager with active parameter.
	 * 
	 * @param code        The reservation code will be generated when a reservation
	 *                    is created.
	 * @param flightCode  The flight code the reservation is for.
